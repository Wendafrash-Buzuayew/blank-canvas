...
public class S3MediaStorageService implements MediaStorageService {
    ...
    /** Local/dev convenience: a fresh MinIO instance has no buckets yet. Real cloud deployments provision the bucket out-of-band, and this is then a no-op HEAD check. */
    @PostConstruct
